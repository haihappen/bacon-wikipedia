...
/***/ function(module, exports, __webpack_require__) {
	...
	var _importsSelfEs6pEs6PromisePromiseEs6pPromiseExportsSelfFetchWhatwgFetch = __webpack_require__(4);

	var _importsSelfEs6pEs6PromisePromiseEs6pPromiseExportsSelfFetchWhatwgFetch2 = _interopRequireDefault(_importsSelfEs6pEs6PromisePromiseEs6pPromiseExportsSelfFetchWhatwgFetch);
	...
	var App = (function (_Component) {
	  function App(props) {
	    ...
	    this.state = { stream: new _baconjs.Bus(), results: new _baconjs.Bus() };
	  }
	  ...
	  App.prototype.componentDidMount = function componentDidMount() {
	    ...
	    var searchWikipedia = function searchWikipedia(term) {
	      return (0, _importsSelfEs6pEs6PromisePromiseEs6pPromiseExportsSelfFetchWhatwgFetch2['default'])('http://en.wikipedia.org/w/api.php?action=opensearch&search=' + term, {
	        headers: {
	    ...
	    this.state.stream.filter(function (v) {
	      return v.length > 2;
	    }).debounce(250) // ms
	    .flatMapLatest(function (term) {
	      return _baconjs2['default'].fromPromise(searchWikipedia(term));
	    }).onValue(function (response) {
	      return _this.setState({
	        results: _baconjs2['default'].zipAsArray(_baconjs2['default'].fromArray(response[1]), _baconjs2['default'].fromArray(response[2]), _baconjs2['default'].fromArray(response[3]))
	      });
	    });
	  };
	  ...
	  App.prototype.render = function render() {
	    ...
	    this.state.results.onValue(function (value) {
	    ...
	    return _react2['default'].createElement(
	      'div',
	      null,
	      _react2['default'].createElement(SearchInput, { stream: this.state.stream }),
	...
	var SearchInput = (function (_Component2) {
	  ...
	  _inherits(SearchInput, _Component2);
	  ...
	  SearchInput.prototype.handleChange = function handleChange() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var self = {};
	var es6p = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(31), __webpack_require__(97).setImmediate, (function() { return this; }()), __webpack_require__(8)(module)))
